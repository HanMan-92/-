...
<div style="
    ...
    padding:2rem 2.5rem 1.6rem; text-align:center;
">
    <!-- ماسات الزوايا -->
    <div style="position:absolute;top:-35px;right:-35px;width:110px;height:110px;
                background:rgba(245,130,31,0.18);transform:rotate(45deg);border-radius:10px;"></div>
    <div style="position:absolute;bottom:-28px;left:-28px;width:90px;height:90px;
                background:rgba(196,18,48,0.22);transform:rotate(45deg);border-radius:8px;"></div>
    <div style="position:absolute;top:18px;left:22px;width:45px;height:45px;
                background:rgba(245,130,31,0.12);transform:rotate(45deg);border-radius:5px;"></div>
    <div style="position:absolute;bottom:18px;right:22px;width:35px;height:35px;
                background:rgba(196,18,48,0.15);transform:rotate(45deg);border-radius:4px;"></div>

    <!-- أفق المدينة / عمران عسير -->
    <svg width="380" height="72" viewBox="0 0 380 72"
         style="display:block;margin:0 auto 1.2rem;opacity:0.65;">
        <rect x="0"   y="44" width="22" height="28" fill="#1B3A6B" opacity="0.5"/>
        <rect x="24"  y="34" width="18" height="38" fill="#C41230" opacity="0.45"/>
        <rect x="44"  y="50" width="14" height="22" fill="#F5821F" opacity="0.4"/>
        <rect x="62"  y="14" width="32" height="58" fill="#1B3A6B" opacity="0.85" stroke="#F5821F" stroke-width="0.6"/>
        <rect x="70"  y="7"  width="16" height="7"  fill="#C41230" opacity="0.9"/>
        <rect x="76"  y="3"  width="4"  height="4"  fill="#F5821F"/>
        <rect x="66" y="18" width="4" height="4" fill="#F5821F" opacity="0.7"/>
        <rect x="73" y="18" width="4" height="4" fill="white" opacity="0.3"/>
        <rect x="80" y="18" width="4" height="4" fill="#F5821F" opacity="0.7"/>
        <rect x="66" y="28" width="4" height="4" fill="white" opacity="0.2"/>
        <rect x="73" y="28" width="4" height="4" fill="#F5821F" opacity="0.8"/>
        <rect x="80" y="28" width="4" height="4" fill="#F5821F" opacity="0.5"/>
        <rect x="98"  y="30" width="24" height="42" fill="#C41230" opacity="0.6"/>
        <rect x="104" y="22" width="12" height="8"  fill="#C41230" opacity="0.7"/>
        <rect x="125" y="38" width="20" height="34" fill="#F5821F" opacity="0.45"/>
        <rect x="148" y="22" width="28" height="50" fill="#1B3A6B" opacity="0.8" stroke="#C41230" stroke-width="0.5"/>
        <rect x="155" y="14" width="14" height="8"  fill="#F5821F" opacity="0.8"/>
        <rect x="180" y="10" width="36" height="62" fill="#1B3A6B" opacity="0.9" stroke="#F5821F" stroke-width="0.7"/>
        <rect x="188" y="4"  width="20" height="6"  fill="#C41230" opacity="0.9"/>
        <rect x="196" y="1"  width="4"  height="3"  fill="#F5821F"/>
        <rect x="184" y="14" width="4" height="4" fill="#F5821F" opacity="0.8"/>
        <rect x="191" y="14" width="4" height="4" fill="white" opacity="0.3"/>
        <rect x="198" y="14" width="4" height="4" fill="#F5821F" opacity="0.8"/>
        <rect x="205" y="14" width="4" height="4" fill="white" opacity="0.25"/>
        <rect x="184" y="24" width="4" height="4" fill="white" opacity="0.25"/>
        <rect x="191" y="24" width="4" height="4" fill="#F5821F" opacity="0.9"/>
        <rect x="198" y="24" width="4" height="4" fill="white" opacity="0.3"/>
        <rect x="205" y="24" width="4" height="4" fill="#F5821F" opacity="0.7"/>
        <rect x="220" y="30" width="22" height="42" fill="#C41230" opacity="0.55"/>
        <rect x="246" y="18" width="26" height="54" fill="#1B3A6B" opacity="0.75" stroke="#F5821F" stroke-width="0.5"/>
        <rect x="252" y="12" width="14" height="6"  fill="#F5821F" opacity="0.7"/>
        <rect x="250" y="22" width="4" height="4" fill="#F5821F" opacity="0.7"/>
        <rect x="257" y="22" width="4" height="4" fill="white" opacity="0.25"/>
        <rect x="276" y="40" width="20" height="32" fill="#F5821F" opacity="0.4"/>
        <rect x="300" y="28" width="24" height="44" fill="#C41230" opacity="0.5"/>
        <rect x="328" y="36" width="18" height="36" fill="#1B3A6B" opacity="0.6"/>
        <rect x="350" y="22" width="28" height="50" fill="#C41230" opacity="0.55" stroke="#F5821F" stroke-width="0.5"/>
        <rect x="357" y="16" width="14" height="6"  fill="#F5821F" opacity="0.7"/>
        <rect x="0" y="70" width="380" height="2" fill="rgba(245,130,31,0.45)"/>
    </svg>

    <!-- اسم التطبيق -->
    <h1 style="color:white;font-size:4.5rem;font-weight:900;margin:0;letter-spacing:8px;
               text-shadow:0 0 40px rgba(196,18,48,0.6),0 2px 4px rgba(0,0,0,0.5);
               line-height:1.1;">جدوى</h1>
    <p style="color:#F5821F;font-size:1.05rem;margin:0.3rem 0 0.9rem;font-weight:500;
              letter-spacing:5px;text-shadow:0 0 12px rgba(245,130,31,0.4);">من عسير</p>
    <p style="color:rgba(255,255,255,0.65);font-size:0.88rem;margin:0;letter-spacing:1px;">
        نظام ذكي لتقييم ملاءمة المواقع التجارية · أبها وخميس مشيط
    </p>

    <!-- فاصل ماسي -->
    <div style="display:flex;justify-content:center;gap:10px;margin-top:1.1rem;align-items:center;">
        <div style="width:5px;height:5px;background:#C41230;transform:rotate(45deg);border-radius:1px;"></div>
        <div style="width:50px;height:1px;background:rgba(245,130,31,0.35);"></div>
        <div style="width:12px;height:12px;background:#F5821F;transform:rotate(45deg);border-radius:2px;
                    box-shadow:0 0 8px rgba(245,130,31,0.5);"></div>
        <div style="width:50px;height:1px;background:rgba(245,130,31,0.35);"></div>
        <div style="width:5px;height:5px;background:#C41230;transform:rotate(45deg);border-radius:1px;"></div>
    </div>
</div>
